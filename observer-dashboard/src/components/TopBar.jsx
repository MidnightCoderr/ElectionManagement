        ...
        <header className="h-14 flex-shrink-0 border-b border-dark-700/50 flex items-center justify-between px-6">
            <div className="flex items-center gap-3">
                <div className="flex items-center gap-2 bg-dark-800 rounded-xl px-3 py-2 w-64">
                    <IconSearch />
                    <input type="text" placeholder="Search elections, candidates..." className="bg-transparent text-sm text-[#1b1710] placeholder-muted outline-none flex-1" />
                </div>
            </div>
            <div className="flex items-center gap-4">
                ...
                <button className="relative text-muted hover:text-[#1b1710] transition-colors">
                    <IconBell />
