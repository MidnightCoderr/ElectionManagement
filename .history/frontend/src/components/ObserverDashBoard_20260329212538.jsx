...
const NAV_ITEMS = [
  ...
  { id:'audit',     section:'Operations', label:'Audit Log', icon:<><path d="M3 2h8a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1V3a1 1 0 0 1 1-1z"/><path d="M4.5 5.5h5M4.5 8h5"/></> },
  { id:'verify',    section:'Operations', label:'Verify Vote', icon:<><path d="M7 2v2M12 7h-2M7 12v-2M2 7h2"/><circle cx="7" cy="7" r="2.5"/></> },
  { id:'terminals', section:'Operations', label:'Terminals', icon:<><rect x="2" y="3.5" width="10" height="7" rx="1.5"/><path d="M5 12h4"/></> },
]
