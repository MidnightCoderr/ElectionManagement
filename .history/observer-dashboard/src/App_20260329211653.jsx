...
const MetricCards = lazy(() => import('./components/MetricCards.jsx'))
const LiveResults = lazy(() => import('./components/LiveResults.jsx'))
        ...
        <div className="flex h-screen overflow-hidden bg-dark-950">
            ...
            <main className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    <Suspense fallback={<SectionSkeleton className="h-[164px]" />}>
                        <MetricCards
                            stats={stats}
                    ...
                    <div className="grid grid-cols-3 gap-4">
                        <Suspense fallback={<SectionSkeleton className="col-span-2 h-[430px]" />}>
                            <LiveResults
                                chartData={chartData}
...
function SectionSkeleton({ className = '' }) {
    return <div className={`w-full rounded-xl bg-dark-800/60 border border-dark-600/30 animate-pulse ${className}`} />
}
