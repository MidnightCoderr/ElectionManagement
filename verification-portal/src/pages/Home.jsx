      ...
      <div style={s.page}>
        ...
        <div style={s.card}>
          ...
          <button style={s.qrBox} onClick={() => setShowScanner(true)} type="button">
            ...
            <div>
              <div style={{ fontWeight:700, fontSize:14, color:'#0F172A' }}>Scan QR Code</div>
              <div style={{ fontSize:11, color:'#94A3B8', marginTop:2 }}>Use camera to scan receipt QR</div>
            </div>
            <span style={{ marginLeft:'auto', color:'rgba(79,70,229,0.8)', fontSize:18 }}></span>
          </button>
        ...
        <div style={s.infoGrid}>
          {[
            ...
            <div key={title} style={s.infoCard}>
              ...
              <div style={{ fontWeight:700, fontSize:12, color:'#0F172A', marginTop:6 }}>{title}</div>
              <div style={{ fontSize:11, color:'#475569', marginTop:3, lineHeight:1.5 }}>{desc}</div>
            </div>
          ))}
        </div>
...
const s = {
  ...
  logoRing: {
    ...
    filter:'drop-shadow(0 0 20px rgba(79,70,229,0.25))',
  },
  title:    { fontSize:26, fontWeight:800, color:'#0B1F3A', margin:0 },
  subtitle: { fontSize:13, color:'#475569', marginTop:5 },
  flagBar: {
  ...
  card: {
    ...
    padding:28, boxShadow:'0 24px 64px rgba(15,23,42,0.08)',
    marginBottom:16,
  },
  cardTitle: { fontSize:16, fontWeight:800, color:'#0B1F3A', marginBottom:8 },
  cardDesc:  { fontSize:12, color:'#475569', lineHeight:1.6, marginBottom:20 },
  label: {
    display:'block', color:'#475569', fontSize:10, fontWeight:700,
    textTransform:'uppercase', letterSpacing:'.06em', marginBottom:5,
  },
  input: {
    width:'100%', background:'#F8FAFC', border:'1px solid #E2E8F0',
    color:'#0F172A', borderRadius:10, padding:'12px 14px',
  ...
  inputErr: { borderColor:'rgba(185,28,28,0.6)' },
  errHint:  { color:'#B91C1C', fontSize:11, marginBottom:4 },
  hint:     { fontSize:11, color:'#94A3B8', marginBottom:18 },
  divider:  { display:'flex', alignItems:'center', gap:10, margin:'4px 0 14px' },
  dividerLine: { flex:1, height:1, background:'#E2E8F0' },
  dividerText: { color:'#94A3B8', fontSize:12 },
  qrBox: {
    width:'100%', display:'flex', alignItems:'center', gap:12,
    background:'#F8FAFC', border:'1px dashed rgba(79,70,229,0.3)',
    borderRadius:12, padding:'12px 14px', cursor:'pointer', marginBottom:16,
    textAlign:'left', color:'#0F172A', fontFamily:'inherit', transition:'border-color .2s',
  },
  verifyBtn: {
    width:'100%', background:'#4F46E5', color:'#fff',
    border:'none', borderRadius:10, padding:'15px 0', fontFamily:'inherit',
    fontSize:15, fontWeight:800, cursor:'pointer',
    boxShadow:'0 4px 16px rgba(79,70,229,0.2)', transition:'background .2s',
  },
  infoGrid: {
